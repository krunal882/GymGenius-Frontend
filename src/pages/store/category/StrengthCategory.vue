<!-- this component is the parent component for the store strength page , it includes the search field , filter , preview card components -->
<template>
  <!-- hero header images -->
...
export default {
  ...
  computed: {
    // to fetch strength product
    filteredProducts() {
      return this.$store.state.productsModule.strength;
    },
  },
};
</script>
