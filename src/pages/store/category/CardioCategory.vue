...
export default {
  ...
  data() {
    return {
      selectedItem: null,
      carouselImages: [
        require("../../../assets/img/cardio/cardio-carousel1.webp"),
        require("../../../assets/img/cardio/cardio-carousel3.webp"),
      ],
      category: "cardio",
      page: 1,
      loading: false,
  ...
  computed: {
    // to fetch cardio product
    filteredProducts() {
      return this.$store.state.productsModule.cardio;
    },
  },
};
</script>
