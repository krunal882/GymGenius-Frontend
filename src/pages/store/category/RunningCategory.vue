<!-- this component is the parent component for the store running page , it includes the search field , filter , preview card components -->
<template>
  <!-- hero header images -->
  ...
  <div class="d-flex flex-wrap justify-content-center">
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-7764190062746470"
     crossorigin="anonymous"></script>
<ins class="adsbygoogle"
     style="display:block"
     data-ad-format="autorelaxed"
     data-ad-client="ca-pub-7764190062746470"
     data-ad-slot="8399923402"></ins>
<script>
...
export default {
  ...
  computed: {
    // to fetch men product
    filteredProducts() {
      return this.$store.state.productsModule.running;
    },
  },
};
</script>
